...
export default function Dashboard() {
  ...
  return (
    <AppLayout title="Dashboard">
      ...
      <div className="stat-grid" aria-busy={loadingStats}>
        {loadingStats
      ...
      <div className="panel-row">
        <div className="panel">
          <div className="panel-head">
            ...
            <div className="tab-row" role="tablist" aria-label="Revenue period">
              <button
                ...
                className={`tab-btn${period === 'week' ? ' on' : ''}`}
              ...
              <button
                ...
                className={`tab-btn${period === 'month' ? ' on' : ''}`}
          ...
          <div className="bars">
            {(period === 'week' ? WEEK_BARS : MONTH_BARS).map((v, i) => (
              <div className="bar-col" key={i}>
                <div className="bar" style={{ height: `${v}%` }} />
                <div className="bar-label">{(period === 'week' ? WEEK_LABELS : MONTH_LABELS)[i]}</div>
              </div>
            ))}
          </div>
        </div>
